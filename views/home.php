<form class="reportform" action="" method="post">
...
<?php 
    ...
    <form action="" method="post">
        ...
        <input type="text" name="code" id="code" placeholder="Digite o Código"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
